			...
			<div class="wrap-table100">
				<div class="table100 ver1 m-b-110">
					...
					<table data-vertable="ver1">
						<thead>
            <div class="col-12">
            <a href="#" class="float-right m-0 btn btn-success font-weight-bold add-btn" data-toggle="modal" data-target="#Add_Course">New Course + </a>
            </div>
						...
						<?php while($row = mysqli_fetch_array($result)){ ?>
								...
								<td class="column100  column1 text-center" data-column="column1"> <?php echo $row['course_id'] ?> </td>
								<td class="column100  column2 w-25" data-column="column2"> <?php echo $row['course_name'] ?> </td>
								...
								<td class="column100 column10 " data-column="column10"><button class="btn btn-md btn-success editbtn">Edit  </button>
									<button class="btn btn-md btn-danger float- "> <a class='text-white btn-del' href="delete.php?course_id=<?php echo $row['course_id']; ?>" name="delete">Delete</a> </button> </td>
								</tr>
							<?php } ?>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header bg-success">
        <h5 class="modal-title" id="exampleModalLongTitle">Enter Course Information</h5>
      ...
      <div class="modal-footer bg-dark">
        ...
        <button type="submit" class="btn btn-primary" name="save_changes_for_course">Save Changes</button>
...
##############################################################################################
 ...
 <div class="modal fade" id="Edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header bg-success">
        <h5 class="modal-title" id="exampleModalLongTitle">Edit Course Information</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-footer bg-dark">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="submit" class="btn btn-primary" name="update_changes_for_course">Update Changes</button>
