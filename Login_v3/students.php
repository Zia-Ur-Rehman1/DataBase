		...
		<div class="container-table100">
            ...
            <a href="#" class="float-right m-0 btn btn-success font-weight-bold add-btn" data-toggle="modal" data-target="#Add_Student">New Student + </a>
                  ...
                  ?>
								...
								<td class="column100 column10 justify-content-center " data-column="column10"><button id="add" class="btn btn-md btn-success editbtn"><a name="edit" class="editbtn" value="Edit" id="<?php echo $row["student_id"]; ?>">Edit</a>  </button>
									<button class="btn btn-md btn-danger float- "> <a class='text-white btn-del' href="delete.php?student_id=<?php echo $row['student_id']; ?>" name="delete">Delete</a> </button> </td>
								</tr>
							<?php } ?>
 ...
 <div class="modal fade" id="Edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form action="update_changes.php"  method="POST" id="update">
      <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" name="roll_no" id="roll_no" placeholder="Roll Number">
          </div>
          ...
          <select  name='dep_id'  class="select" id='dep_id' required>
              <?php
              $sql1="SELECT *  FROM department";
          ...
          <div class="form-group">
            ...
            <input type="phone" class="form-control" name="phone_no" id="phone" placeholder="Phone Number">
          </div>
